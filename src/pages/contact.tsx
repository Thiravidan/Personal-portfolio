    ...
    <Layout>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div ref={contactRef} className={`grid lg:grid-cols-2 gap-12 items-center ${contactVisible ? 'opacity-100' : 'opacity-0'}`}>
            {/* Contact Info */}
            <div className="space-y-8">
              <div className={`bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 card-hover touch-ripple ${contactVisible ? 'card-entrance-left' : ''}`}>
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:thiravidantamizhan@gmail.com" className="text-emerald-300 hover:text-emerald-200 transition-colors">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+919123563645" className="text-emerald-300 hover:text-emerald-200 transition-colors">
                        +91 9123563645
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-emerald-300">Sivaganga, Tamil Nadu, India</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Social Links */}
            <div className={`bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 card-hover touch-ripple ${contactVisible ? 'card-entrance-right' : ''}`}>
              <h2 className="text-2xl font-bold text-white mb-6">Follow Me</h2>
              
              <div className="grid grid-cols-2 gap-4">
                <a 
                  href="https://github.com/Thiravidan" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 bg-white/10 hover:bg-white/20 transition-all duration-300 p-4 rounded-xl border border-white/20 touch-ripple"
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">@Thiravidan</p>
                  </div>
                </a>
                
                <a 
                  href="https://linkedin.com/in/thiravidan" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 bg-white/10 hover:bg-white/20 transition-all duration-300 p-4 rounded-xl border border-white/20 touch-ripple"
                >
                ...
                <a 
                  href="https://leetcode.com/u/Thiravidan_2004/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 bg-white/10 hover:bg-white/20 transition-all duration-300 p-4 rounded-xl border border-white/20 touch-ripple"
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Thiravidan_2004</p>
                  </div>
                </a>
